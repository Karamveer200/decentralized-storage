...
contract ChunkManager {
    ...
    function storeFileHash(bytes32 _fileHash, string memory _uniqueId) public {
    ...
    function validateFileAuthenticity(bytes32 _fileHash, string memory _uniqueId) internal view returns (bool) {
