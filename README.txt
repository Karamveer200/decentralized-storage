...
1. Clone GitHub Repository
    ...
    Clone the GitHub repository containing the smart contracts into Remix IDE from the URL: https://github.com/Karamveer200/decentralized-storage.
...
2. Deploy Contract with Gwei
    ...
    Specify an address from which the contract will be deployed. You can use an address like 0x55Cc5bF403e420057c457740F8838084C5DC3490 or other addresses from https://vanity-eth.tk/.
...
To add storage nodes, follow these steps:
    ...
    Call the "addNode" function with the following parameters:
        _nodeAddress: Address of the storage node. You can use any address obtained from https://vanity-eth.tk/.
